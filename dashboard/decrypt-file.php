    ...
    <div class="col-md-12">
      <div class="card card-signin flex-row my-5">
        <div class="card-body">
          ...
          ?>
          <h3 align="center">File Enkripsi <i style="color:blue"><?php echo $data2['file_name_finish'] ?></i></h3><br>
              ...
              <table class="table striped">
               ...
               <tr>
                 ...
                 <td><?php echo $data2['file_name_finish']; ?>
                  <hr>
                   <a href="file_encrypt/<?php echo $data2['file_name_finish']; ?>" class="btn btn-primary btn-sm">Download</a>
                 </td>
               ...
               <tr>
                 ...
                 <td>
                   <div class="col-md-6">
                    ...
                    <input class="form-control" id="inputPassword" type="password" placeholder="Password / Kunci Enkripsi" name="pwdfile" required><br>
                    <input type="submit" name="decrypt_now" value="DESKRIPSI" class="form-control btn btn-primary">
                  </div>
                </td>
              </tr>
            </table>
