    ...
    <div class="card-body">
        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    <td> - Menu Berkas terbagi 2 yakni Enkripsi dan Dekripsi</td>
                </tr>
                <tr>
                    <td> - Untuk Mengenkripsi file pilih pada menu Berkas -> Enkripsi</td>
                </tr>
                <tr>
                    <td> - Untuk Mengdekripsi file pilih pada menu Berkas -> Dekripsi</td>
                </tr>
                <tr>
